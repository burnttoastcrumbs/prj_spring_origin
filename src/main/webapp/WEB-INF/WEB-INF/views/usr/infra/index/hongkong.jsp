...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/hongkong.css">
    <script src="/resources/js/jquery-3.6.4.min.js"></script>
    <script src="/resources/js/hongkong.js"></script>
...
<!-- 내용 -->
<img src="/resources/img/hong1.jpeg" alt="" class="backgroundImage">
<img src="/resources/img/hong4.jpeg" alt="" class="backgroundImage">
<img src="/resources/img/hong2.jpeg" alt="" class="backgroundImage">

<img src="/resources/img/hong30.jpeg" alt="" class="banners backgroundImage">
<section class="con">
    <div class="wrap">
        <div class="cruise_25_2">
            <ul>
                <c:forEach items="${list18}" var="hongkong" varStatus="status">
                    <li class="cruise_25_con">
                        <a href="/middle?seq=<c:out value="${hongkong.seq}"/>&same=<c:out value="${hongkong.same}"/>">
                            <img src="/resources/<c:out value="${hongkong.detailPage_img}">img/cruise1.jpeg</c:out>" alt="">
                        </a>
                        <div class="cruise_25_content">
                            <p><c:out value="${hongkong.middlePageTitle}">로마와 동부 지중해 크루즈 10일 #발코니 선실</c:out></p>
                            <p><c:out value="${hongkong.detailPage_Detail}">이탈리아, 몰타, 그리스</c:out></p>
                            <p><fmt:formatNumber type="number" maxFractionDigits="3" value="${hongkong.adult_price}" />원~</span></p>
                        </div>
                    </li>
                </c:forEach>
