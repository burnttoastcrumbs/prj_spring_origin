				...
				<!-- End Messages Icon -->
					...
					<ul
						...
						<li class="message-item"><a href="#"> <img
								src="/resources/assets/img/messages-1.jpg" alt=""
						...
						<li class="message-item"><a href="#"> <img
								src="/resources/assets/img/messages-2.jpg" alt=""
								class="rounded-circle">
								<div>
									<h4>Anna Nelson</h4>
									<p>Velit asperiores et ducimus soluta repudiandae labore
						...
						<li class="message-item"><a href="#"> <img
								src="/resources/assets/img/messages-3.jpg" alt=""
								class="rounded-circle">
								<div>
									<h4>David Muldon</h4>
									<p>Velit asperiores et ducimus soluta repudiandae labore
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="tables-nav" class="nav-content collapse "
					...
					<li><a href="/codeGroupXdmList"> <i class="bi bi-circle"></i><span>Data Tables</span>
					</a></li>
				</ul></li>
			<!-- End Tables Nav -->
										...
										<tbody>
											<tr>
												<th scope="row"><a href="#"><img
														src="/resources/assets/img/product-1.jpg" alt=""></a></th>
											...
											<tr>
												<th scope="row"><a href="#"><img
														src="/resources/assets/img/product-2.jpg" alt=""></a></th>
											...
											<tr>
												<th scope="row"><a href="#"><img
														src="/resources/assets/img/product-3.jpg" alt=""></a></th>
											...
											<tr>
												<th scope="row"><a href="#"><img
														src="/resources/assets/img/product-4.jpg" alt=""></a></th>
											...
											<tr>
												<th scope="row"><a href="#"><img
														src="/resources/assets/img/product-5.jpg" alt=""></a></th>
