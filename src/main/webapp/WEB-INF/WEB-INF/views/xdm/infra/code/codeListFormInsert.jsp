					...
					<div class="card">
						<div class="card-body">
							<form name="form" method="post">
								...
								<input type="text"  name="codegroup_seq" id="codegroup_seq" placeholder="codegroup_seq(필수!)"  value="<c:out value="${item.codegroup_seq}"/>">
								<input type="text"  name="name" id="name"  placeholder="name"  value="<c:out value="${item.name}"/>">
								<input type="text" class="form-control" id="delNy" name="delNy" placeholder="delNy" value="<c:out value="${item.delNy}"/>">
