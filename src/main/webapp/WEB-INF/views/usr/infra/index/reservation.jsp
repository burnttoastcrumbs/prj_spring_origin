...
<section>
    <div id="sectionWrap">
        ...
        <!-- <div id="nothing">
            ...
            <p>현재 예약내역이 존재하지 않습니다.</p>
            <p>즐거운 여행계획을 준비해 보세요.</p>
        </div> -->
        <div id="new_contents_container" class="scroll_bar">
            <ul id="reserved">
                <li>
                    <ul>
                        <li><span>2023</span>/<span>06</span>/<span>14</span></li>
                        <li>[출발확정] 다낭 4일 #시내 4성호텔 #바나힐 테마파크 #호이안 #전신마사지 #캔들라이트 디너</li>
                        <li><span>501,200</span>원</li>
                        <li><span>1</span>명</li>
                        <li><p><span>2023</span>/<span>06</span>/<span>14</span></p>
                            <p><span>2023</span>/<span>06</span>/<span>14</span></p>
                        </li>
                        <li>Y</li>
                    </ul>
                </li>
