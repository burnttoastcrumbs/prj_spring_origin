							...
							<table class="table">
								<thead>
									<tr>
										...
										<button type="button" class="btn btn-primary" id="btnInsert" onclick="location.href='/codeGroupListFormInsert'">Insert</button>
										...
										<c:otherwise>
											...
											<c:forEach items="${list}" var="list" varStatus="status">
												 <tr>
													 ...
													 <td><a href="/codeGroupListForm?seq=<c:out value="${list.seq}"/>"><c:out value="${list.name}"></c:out></a></td>
